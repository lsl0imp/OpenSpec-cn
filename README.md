...
本项目是在OpenSpec基础上进行中文化，主要是操作过程中的文档中文化。对话过程中的指令也进行中文化对应，详情参考文档 [openspec/CHINESE_MAPPING.md](openspec/CHINESE_MAPPING.md)。以下原项目指南中文翻译，对应修改了安装方式，原项目地址为[OpenSpec](https://github.com/Fission-AI/OpenSpec)。
